...
public class Dcr10_MailSenderPDF {
...
//		table.addCell(cell);
	...
	//row 1 
		...
		//상신일
		cell = rowCellLayout.getCell("상신일 :", Element.ALIGN_RIGHT);
		cell.setColspan(4);
		cell.setBorder(1);//1
		table.addCell(cell);
		...
		//시행일
		cell = rowCellLayout.getCell("시행일 :", Element.ALIGN_RIGHT);
		cell.setColspan(5);
		cell.setBorder(1);//1
		table.addCell(cell);
	...
	//row 2 
		...
		//담당자
		cell = rowCellLayout.getCell("담당자 :", Element.ALIGN_RIGHT);
		cell.setColspan(4);
		cell.setBorder(0);
		table.addCell(cell);
		...
		//부서장
		cell = rowCellLayout.getCell("부서장 :", Element.ALIGN_RIGHT);
		cell.setColspan(5);
		cell.setBorder(0);
		table.addCell(cell);
	...
	//row 3
		...
		//이메일
		cell = rowCellLayout.getCell("이메일 :", Element.ALIGN_RIGHT);
		cell.setColspan(4);
		cell.setBorder(0);
		table.addCell(cell);
		...
		//전화번호
		cell = rowCellLayout.getCell("전화번호 :", Element.ALIGN_RIGHT);
		cell.setColspan(5);
		cell.setBorder(0);
		table.addCell(cell);
	...
	//row4 
		...
		//주소
		cell = rowCellLayout.getCell("주소 :", Element.ALIGN_RIGHT);
		cell.setColspan(4);
		cell.setBorder(2);
		table.addCell(cell);
