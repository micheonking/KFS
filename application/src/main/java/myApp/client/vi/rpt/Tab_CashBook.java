...
import myApp.client.vi.rpt.model.CashBookModelProperties;
...
//		gridBuilder.addText(properties.yearMonth()		,	80	,	"해당월"		,	HasHorizontalAlignment.ALIGN_CENTER	,	null);	//	); // not editable 
		...
		gridBuilder.addText(properties.accountName()	,	200	,	"계정과목"		);	//	new TextField()); 
		gridBuilder.addText(properties.transDescript()	,	300	,	"적요사항"		);	//	new TextField()); 
