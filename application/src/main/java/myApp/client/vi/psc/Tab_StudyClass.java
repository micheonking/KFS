...
import myApp.client.vi.psc.model.StudyClassModelProperties;
...
//		service.addParam("companyId", LoginUser.getLoginUser().getCompanyId());
	...
	@Override
	public void update(){
		GridUpdate<StudyClassModel> service = new GridUpdate<StudyClassModel>(); 
...
//		studyClassModel.setCompanyId(LoginUser.getLoginUser().getCompanyId());
		studyClassModel.setCompanyId(LoginUser.getCompanyId());
	...
	public void deleteRow(){
		...
		service.delete(grid.getStore(), checkedList, "psc.StudyClass.delete");
	}
