...
import myApp.client.vi.sys.Lookup_UserImage;
...
public class TabPage_Student extends ContentPanel implements Editor<StudentModel>, InterfaceTabPage, InterfaceLookupResult, InterfaceGridOperate {
	...
	public void insertRow() {
		...
		student.setCompanyId(LoginUser.getCompanyId());
	...
	public void update(){
		...
		GridUpdate<StudentModel> service = new GridUpdate<StudentModel>(); 
	...
	public void deleteRow() {
		...
		service.delete(this.grid.getStore(), checkedList, "psc.Student.delete");
	}
}